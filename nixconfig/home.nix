...
let
  ...
  shellAliases =
    ...
    in
    {
      ll = "ls -l";
      rpi4 = "et rpi4";
      getsha256 = "nix-prefetch-url --type sha256 --unpack $1"; # $1 link to tar.gz release archive in github
      termcopy = "kitty +kitten ssh $1"; # copy terminal info to remote server $1 = remote server
      ...
      captiveportal = "xdg-open http://$(ip --oneline route get 1.1.1.1 | awk '{print $3}')";

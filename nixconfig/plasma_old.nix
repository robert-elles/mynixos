{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "ActivityManager"."switch-to-activity-8e4000ef-8227-47c1-9e65-49c909c5d402" = ",none,Switch to activity \"Default\"";
      ...
      "khotkeys"."{7b921d48-5926-4701-bcfe-717dbcedc00c}" = "Ctrl+Alt+T,none";
      ...
      "kwin"."Expose" = "Meta+Z,Ctrl+F9,Toggle Present Windows (Current desktop)";
      "kwin"."ExposeAll" = ["Meta+Shift+Z,Ctrl+F10" "Launch (C),Toggle Present Windows (All desktops)"];
      ...
      "kwin"."Walk Through Windows Alternative" = "Meta+L,,Walk Through Windows Alternative";
      "kwin"."Walk Through Windows Alternative (Reverse)" = "Meta+H,,Walk Through Windows Alternative (Reverse)";
      ...
      "kwin"."Window Maximize" = ["Meta+M" "Meta+PgUp" "Meta+F,Meta+PgUp,Maximize Window"];
      ...
      "kwin"."Window Quick Tile Left" = ["Meta+Shift+H" "Meta+Left,Meta+Left,Quick Tile Window to the Left"];
      "kwin"."Window Quick Tile Right" = ["Meta+Shift+L" "Meta+Right,Meta+Right,Quick Tile Window to the Right"];
      "kwin"."Window Quick Tile Top" = ["Meta+Shift+K" "Meta+Up,Meta+Up,Quick Tile Window to the Top"];
      ...
      "kwin"."bismuth_decrease_window_height" = "Meta+Ctrl+K,none";
      "kwin"."bismuth_decrease_window_width" = "Meta+Ctrl+H,none";
      "kwin"."bismuth_focus_bottom_window" = "Meta+J,none";
      ...
      "kwin"."bismuth_focus_upper_window" = "Meta+K,none";
      "kwin"."bismuth_increase_master_size" = [ ];
      "kwin"."bismuth_increase_master_win_count" = [ ];
      "kwin"."bismuth_increase_window_height" = "Meta+Ctrl+J,none";
      "kwin"."bismuth_increase_window_width" = "Meta+Ctrl+L,none";
      ...
      "kwin"."bismuth_prev_layout" = "Meta+|,none";
      "kwin"."bismuth_push_window_to_master" = "Meta+Shift+M,none";
      "kwin"."bismuth_rotate" = [ ];
      "kwin"."bismuth_rotate_part" = "Meta+Shift+R,none";
      ...
      "kwin"."bismuth_toggle_stair_layout" = "Meta+W,none";
      "kwin"."bismuth_toggle_three_column_layout" = [ ];
      "kwin"."bismuth_toggle_tile_layout" = "Meta+T,none";
      "kwin"."bismuth_toggle_window_floating" = "Meta+Shift+Space,none";
    ...
    configFile = {
      ...
      "dolphinrc"."ExtractDialog"."DirHistory[$e]" = "$HOME/Downloads/up adapter/";
      "dolphinrc"."General"."ViewPropsTimestamp" = "2024,7,3,17,30,13.939";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."8e4000ef-8227-47c1-9e65-49c909c5d402" = "Main";
      "kactivitymanagerdrc"."main"."currentActivity" = "8e4000ef-8227-47c1-9e65-49c909c5d402";
      "kactivitymanagerdrc"."main"."runningActivities" = "8e4000ef-8227-47c1-9e65-49c909c5d402";
      ...
      "kcminputrc"."Libinput/4403/91161/Logitech Wireless Keyboard PID:4023"."ScrollFactor" = 20;
      "kcminputrc"."Libinput/5945/197507/DLL075B:01 06CB:76AF Touchpad"."ClickMethod" = 2;
      "kcminputrc"."Libinput/5945/197507/DLL075B:01 06CB:76AF Touchpad"."PointerAcceleration" = 0.4;
      "kcminputrc"."Libinput/5945/197507/DLL075B:01 06CB:76AF Touchpad"."ScrollFactor" = 1.5;
      "kcminputrc"."Libinput/5945/197507/DLL075B:01 06CB:76AF Touchpad"."TapToClick" = true;
      ...
      "ksmserverrc"."SubSession: 5ce10bce-590d-47c6-b067-67fde6be1007"."count" = 0;
      "ksmserverrc"."SubSession: 8e4000ef-8227-47c1-9e65-49c909c5d402"."count" = 0;
      "kwalletrc"."Wallet"."First Use" = false;
      "kwinrc"."Activities/LastVirtualDesktop"."5ce10bce-590d-47c6-b067-67fde6be1007" = "da30d27e-5139-4c9b-87f9-134abd80ec02";
      ...
      "kwinrc"."SubSession: 8e4000ef-8227-47c1-9e65-49c909c5d402"."active" = "-1";
      "kwinrc"."SubSession: 8e4000ef-8227-47c1-9e65-49c909c5d402"."count" = 0;
      ...
      "kwinrc"."Tiling/07ed97c2-12b4-5349-b502-a095df5d8eb0"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}x5d}";
      ...
      "kwinrulesrc"."155d0c34-102e-46ad-a3b4-f160b958335e"."Description" = "Application settings for super productivity";
      "kwinrulesrc"."155d0c34-102e-46ad-a3b4-f160b958335e"."activity" = "00000000-0000-0000-0000-000000000000";
      "kwinrulesrc"."155d0c34-102e-46ad-a3b4-f160b958335e"."activityrule" = 3;
      "kwinrulesrc"."155d0c34-102e-46ad-a3b4-f160b958335e"."clientmachine" = "localhost";
      "kwinrulesrc"."155d0c34-102e-46ad-a3b4-f160b958335e"."desktops" = "38edeb19-1d3e-42f8-9d86-e9896b11eb3e";
      "kwinrulesrc"."155d0c34-102e-46ad-a3b4-f160b958335e"."desktopsrule" = 3;
      "kwinrulesrc"."155d0c34-102e-46ad-a3b4-f160b958335e"."wmclass" = "super";
      "kwinrulesrc"."155d0c34-102e-46ad-a3b4-f160b958335e"."wmclassmatch" = 2;
      ...
      "kwinrulesrc"."f40dfb50-ee75-44d8-b504-2478aca1f98e"."Description" = "Application settings for superProductivity";
      "kwinrulesrc"."f40dfb50-ee75-44d8-b504-2478aca1f98e"."clientmachine" = "localhost";
      "kwinrulesrc"."f40dfb50-ee75-44d8-b504-2478aca1f98e"."desktops" = "38edeb19-1d3e-42f8-9d86-e9896b11eb3e";
      "kwinrulesrc"."f40dfb50-ee75-44d8-b504-2478aca1f98e"."desktopsrule" = 3;
      "kwinrulesrc"."f40dfb50-ee75-44d8-b504-2478aca1f98e"."wmclass" = "superproductivity superProductivity";
      "kwinrulesrc"."f40dfb50-ee75-44d8-b504-2478aca1f98e"."wmclasscomplete" = true;
      "kwinrulesrc"."f40dfb50-ee75-44d8-b504-2478aca1f98e"."wmclassmatch" = 2;
      ...
      "plasmanotifyrc"."Applications/org.gnome.clocks"."Seen" = true;
      "plasmanotifyrc"."Applications/org.rncbc.qpwgraph"."Seen" = true;

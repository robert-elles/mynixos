{
  programs.plasma = {
    ...
    configFile = {
      ...
      "kwinrc"."Activities/LastVirtualDesktop"."392857f2-bc27-4ff4-ac67-48f310ff879c" = "53d93476-07e9-4303-afe6-70938407f287";
      "kwinrc"."Activities/LastVirtualDesktop"."4a162aea-a0f9-4acb-a72d-2c48d7816b0b" = "b76cf321-a983-4890-9bc6-965f2bc129b5";
      ...
      "kwinrc"."NightColor"."NightTemperature" = 1900;

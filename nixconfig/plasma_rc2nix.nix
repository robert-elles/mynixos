{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "kwin"."Window Operations Menu" = ["Alt+Q" "Alt+F3,Alt+F3,Window Operations Menu"];
    ...
    configFile = {
      ...
      "kwinrc"."Activities/LastVirtualDesktop"."4a162aea-a0f9-4acb-a72d-2c48d7816b0b" = "53d93476-07e9-4303-afe6-70938407f287";
      "kwinrc"."Activities/LastVirtualDesktop"."da6d1ebe-0d14-4fd8-9b93-0776e6065f49" = "e98ce1dd-607a-4a8e-b924-e03007259846";
      "kwinrc"."Desktops"."Id_1" = "e98ce1dd-607a-4a8e-b924-e03007259846";

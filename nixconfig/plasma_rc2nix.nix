{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      kwin."Window Close" = ["Meta+Shift+Q" "Alt+F4\\, Alt+F4\\, "];
      ...
      plasmashell."previous activity" = ["Meta+Shift+Z" "" ""];
      plasmashell.repeat_action = [ ];
      plasmashell."show dashboard" = "Ctrl+F12";
      plasmashell.show-barcode = [ ];
      plasmashell.show-on-mouse-pos = "Meta+V";
      plasmashell."switch to next activity" = "Meta+A";
      plasmashell."switch to previous activity" = ["Meta+Shift+A" "" ""];
    ...
    configFile = {
      ...
      dolphinrc.General.ViewPropsTimestamp = "2025,12,15,15,2,18.6";
      ...
      plasmaparc.General.GlobalMuteSinksMutedDevices = "easyeffects_sink.4294967295,alsa_output.pci-0000_06_00.6.analog-stereo.0";

{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "kwin"."Walk Through Windows Alternative" = "Meta+K,none,Walk Through Windows Alternative";
      "kwin"."Walk Through Windows Alternative (Reverse)" = "Meta+J,none,Walk Through Windows Alternative (Reverse)";
    ...
    configFile = {
      ...
      "kwinrc"."Tiling/Desktop_1/0dfdf192-d571-4f0c-a980-83ab0a100598"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/Desktop_10/0dfdf192-d571-4f0c-a980-83ab0a100598"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/Desktop_2/0dfdf192-d571-4f0c-a980-83ab0a100598"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/Desktop_3/0dfdf192-d571-4f0c-a980-83ab0a100598"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/Desktop_4/0dfdf192-d571-4f0c-a980-83ab0a100598"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/Desktop_5/0dfdf192-d571-4f0c-a980-83ab0a100598"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/Desktop_6/0dfdf192-d571-4f0c-a980-83ab0a100598"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrulesrc"."7"."Description" = "Geeqie";
      "kwinrulesrc"."7"."maximizehoriz" = true;
      "kwinrulesrc"."7"."maximizehorizrule" = 3;
      "kwinrulesrc"."7"."maximizevert" = true;
      "kwinrulesrc"."7"."maximizevertrule" = 3;
      "kwinrulesrc"."7"."wmclass" = "geeqie Geeqie";
    ...
    dataFile = {
      "kate/anonymous.katesession"."Document 0"."URL" = "file:///home/robert/Downloads/Kalender – Universität der Künste Berlin.html";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-0-Splitter" = 1295;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-1-Splitter" = 1295;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-3-Splitter" = 2168;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-V-Splitter" = "0,1295,0";
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 0"."CursorColumn" = 14;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 0"."CursorLine" = 189;

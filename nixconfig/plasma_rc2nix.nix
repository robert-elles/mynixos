{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-bab85df5-8ace-46a2-b322-d4b939cc627b" = [ ];
      ...
      "kwin"."Expose" = ",Ctrl+F9,Toggle Present Windows (Current desktop)";
      "kwin"."ExposeAll" = ["" "Launch (C),Ctrl+F10" "Launch (C),Toggle Present Windows (All desktops)"];
      "kwin"."ExposeClass" = ",Ctrl+F7,Toggle Present Windows (Window class)";
      ...
      "kwin"."Switch to Desktop 10" = ["" "Ctrl+F10\\, Ctrl+F10\\, ,,Switch to Desktop 10"];
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."bab85df5-8ace-46a2-b322-d4b939cc627b" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "bab85df5-8ace-46a2-b322-d4b939cc627b";
      ...
      "kwinrc"."Desktops"."Id_1" = "7097e3f3-7740-409e-bec3-3673ffb3dc16";

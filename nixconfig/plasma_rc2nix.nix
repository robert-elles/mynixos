{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "kwin"."Walk Through Windows Alternative" = "Meta+K,,Walk Through Windows Alternative";
      "kwin"."Walk Through Windows Alternative (Reverse)" = "Meta+J,,Walk Through Windows Alternative (Reverse)";
